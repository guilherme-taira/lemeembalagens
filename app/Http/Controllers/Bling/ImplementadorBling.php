...
class ImplementadorBling  implements CalculadorPlataformas
{
    public function CalculaMarketplace(string $sku, float $valor, float $stock, float $peso, float $taxa)
    {
        $BlingPut = new PutProdutoController($sku,'a0e92e1b13cad53953fa6b425bc6cb36bcf51d327ec8ca3c9a0c20d271edb3585cc96277',$valor,$this->CalcularEstoque($stock));
        $BlingPut->resource();
    }
